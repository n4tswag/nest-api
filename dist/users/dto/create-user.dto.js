...
__decorate([
    ...
    (0, class_validator_1.IsEmail)({}, { message: 'Incorrect e-mail' }),
    __metadata("design:type", String)
], CreateUserDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '12345678', description: 'password' }),
    (0, class_validator_1.IsString)({ message: 'Must be a string' }),
    (0, class_validator_1.Length)(4, 16, { message: 'Password must contain at least 4 symbols and can not be bigger than 16' }),
    __metadata("design:type", String)
